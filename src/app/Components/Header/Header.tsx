                ...
                <nav className='relative z-50 flex justify-between'>
                    ...
                    <div className="flex items-center gap-x-5 md:gap-x-8">
                        <div className="hidden md:block">
                            <a href="/login" className="inline-block font-semibold rounded-lg px-2 py-1 text-slate-700 hover:bg-slate-100 hover:text-slate-900">Sign in</a>
                        </div>
                        <a href="/register" className='group inline-flex items-center justify-center rounded-full py-2 px-4 font-semibold focus-visible:outline-2 focus-visible:outline-offset-2 bg-blue-600 text-white hover:text-slate-100 hover:bg-blue-500 active:bg-blue-800 active:text-blue-100 focus-visible:outline-blue-600'>Get started today</a>
